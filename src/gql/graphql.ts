...
export type ProductQuery = { products: Array<{ lowestPrice?: number | null, previousPrice?: number | null, quantity?: number | null, description: string, slug: string, name: string, price: number, images: Array<{ url: string }>, categories: Array<{ name: string }> }> };

export type ProductCommonFragment = { slug: string, name: string, price: number, images: Array<{ url: string }>, categories: Array<{ name: string }> };

export type ProductDetailsFragment = { lowestPrice?: number | null, previousPrice?: number | null, quantity?: number | null, description: string, slug: string, name: string, price: number, images: Array<{ url: string }>, categories: Array<{ name: string }> };
...
export type ProductsGetAllQuery = { products: Array<{ slug: string, name: string, price: number, images: Array<{ url: string }>, categories: Array<{ name: string }> }>, productsConnection: { pageInfo: { pageSize?: number | null }, aggregate: { count: number } } };
...
export type ProductsGetByCategorySlugQuery = { categories: Array<{ products: Array<{ slug: string, name: string, price: number, images: Array<{ url: string }>, categories: Array<{ name: string }> }> }>, productsConnection: { pageInfo: { pageSize?: number | null }, aggregate: { count: number } } };
...
export type ProductsGetBySearchQueryQuery = { products: Array<{ slug: string, name: string, price: number, images: Array<{ url: string }>, categories: Array<{ name: string }> }> };
...
export type ProductsGetMostPopularQuery = { products: Array<{ slug: string, name: string, price: number, images: Array<{ url: string }>, categories: Array<{ name: string }> }> };

export type ProductsGetTopQueryVariables = Exact<{ [key: string]: never; }>;


export type ProductsGetTopQuery = { products: Array<{ slug: string, name: string, price: number, images: Array<{ url: string }>, categories: Array<{ name: string }> }> };
