...
export type OrderStatus = "Cancelled" | "Completed" | "Declined" | "Pending" | "Shipped";
...
export type ProductColorVariant = Entity &
	Node & {
		color: ProductColor;
		/** The time the document was created */
		createdAt: Scalars["DateTime"]["output"];
...
export type OrdersGetAllQuery = {
	orders: Array<{ id: string; currentStatus: OrderStatus; updatedAt: unknown; total: number }>;
};
...
export type ProductsGetAllQuery = {
	...
	productsConnection: { pageInfo: { pageSize?: number | null }; aggregate: { count: number } };
};

export type ProductsGetAllByCollectionSlugQueryVariables = Exact<{
	query: Scalars["String"]["input"];
}>;

export type ProductsGetAllByCollectionSlugQuery = {
	products: Array<{
		id: string;
		slug: string;
		name: string;
...
export type ProductsGetBySearchQueryQuery = {
	products: Array<{
		id: string;
		slug: string;
		name: string;
...
export type ProductsGetMostPopularQuery = {
	products: Array<{
		id: string;
		slug: string;
		name: string;
...
export type ProductsGetTopQuery = {
	products: Array<{
		id: string;
		slug: string;
		name: string;
...
export type ReviewsGetByProductQuery = {
	reviews: Array<{
		name: string;
		title: string;
		rating: number;
...
export const ProductCommonFragmentDoc = {
	kind: "Document",
	definitions: [
		{
			kind: "FragmentDefinition",
			name: { kind: "Name", value: "ProductCommon" },
			...
			selectionSet: {
				...
				selections: [
					...
					{ kind: "Field", name: { kind: "Name", value: "previousPrice" } },
...
} as unknown as DocumentNode<ProductCommonFragment, unknown>;
	...
	definitions: [
		{
			...
			selectionSet: {
				...
				selections: [
					...
					{ kind: "FragmentSpread", name: { kind: "Name", value: "ProductCommon" } },
				],
			},
		},
		{
	...
	definitions: [
		{
			...
			operation: "mutation",
			name: { kind: "Name", value: "CartAddProduct" },
			variableDefinitions: [
				{
			...
			selectionSet: {
				...
				selections: [
					{
						kind: "Field",
						name: { kind: "Name", value: "createOrderItem" },
						arguments: [
							{
								kind: "Argument",
...
} as unknown as DocumentNode<CartAddProductMutation, CartAddProductMutationVariables>;
export const CartChangeProductQuantityDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "mutation",
			name: { kind: "Name", value: "CartChangeProductQuantity" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: { kind: "Variable", name: { kind: "Name", value: "cartId" } },
			...
			selectionSet: {
				...
				selections: [
					{
						kind: "Field",
						name: { kind: "Name", value: "upsertOrderItem" },
						arguments: [
							{
								kind: "Argument",
	...
	CartChangeProductQuantityMutationVariables
>;
	...
	definitions: [
		{
			...
			variableDefinitions: [
				...
				{
					kind: "VariableDefinition",
					variable: { kind: "Variable", name: { kind: "Name", value: "currentStatus" } },
					type: {
						kind: "NonNullType",
								...
								value: {
									...
									fields: [
										...
										},
										{
											...
											value: { kind: "Variable", name: { kind: "Name", value: "currentStatus" } },
										},
									],
								},
							},
	...
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "CartGetById" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
...
} as unknown as DocumentNode<CartGetByIdQuery, CartGetByIdQueryVariables>;
export const CartRemoveProductDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "mutation",
			name: { kind: "Name", value: "CartRemoveProduct" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: { kind: "Variable", name: { kind: "Name", value: "productId" } },
			...
			selectionSet: {
				...
				selections: [
					{
						kind: "Field",
						name: { kind: "Name", value: "deleteOrderItem" },
						arguments: [
							{
								kind: "Argument",
								name: { kind: "Name", value: "where" },
...
export const CollectionsGetAllDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "CollectionsGetAll" },
			selectionSet: {
				kind: "SelectionSet",
				selections: [
					{
...
} as unknown as DocumentNode<CollectionsGetAllQuery, CollectionsGetAllQueryVariables>;
	...
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "OrdersGetAll" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: { kind: "Variable", name: { kind: "Name", value: "userId" } },
...
} as unknown as DocumentNode<OrdersGetAllQuery, OrdersGetAllQueryVariables>;
export const ProductGetByIdDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "ProductGetById" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
...
} as unknown as DocumentNode<ProductGetByIdQuery, ProductGetByIdQueryVariables>;
export const ProductGetBySlugDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "ProductGetBySlug" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
...
} as unknown as DocumentNode<ProductGetBySlugQuery, ProductGetBySlugQueryVariables>;
export const ProductsGetAllDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "ProductsGetAll" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
							...
							selections: [
								{
									...
									selectionSet: {
										kind: "SelectionSet",
										selections: [{ kind: "Field", name: { kind: "Name", value: "pageSize" } }],
									},
								},
								{
									kind: "Field",
...
} as unknown as DocumentNode<ProductsGetAllQuery, ProductsGetAllQueryVariables>;
export const ProductsGetAllByCollectionSlugDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "ProductsGetAllByCollectionSlug" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
						...
						arguments: [
							{
								...
								value: {
									...
									fields: [
										{
											kind: "ObjectField",
											name: { kind: "Name", value: "collections_some" },
											value: {
												kind: "ObjectValue",
												fields: [
													{
	...
	ProductsGetAllByCollectionSlugQuery,
	ProductsGetAllByCollectionSlugQueryVariables
>;
export const ProductsGetByCategorySlugDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "ProductsGetByCategorySlug" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: { kind: "Variable", name: { kind: "Name", value: "first" } },
...
>;
export const ProductsGetBySearchQueryDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
...
} as unknown as DocumentNode<ProductsGetBySearchQueryQuery, ProductsGetBySearchQueryQueryVariables>;
	...
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "ProductsGetMostPopular" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: { kind: "Variable", name: { kind: "Name", value: "slug" } },
...
} as unknown as DocumentNode<ProductsGetMostPopularQuery, ProductsGetMostPopularQueryVariables>;
export const ProductsGetTopDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "ProductsGetTop" },
			selectionSet: {
				kind: "SelectionSet",
				selections: [
					{
...
} as unknown as DocumentNode<ProductsGetTopQuery, ProductsGetTopQueryVariables>;
export const ReviewCreateDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
...
} as unknown as DocumentNode<ReviewCreateMutation, ReviewCreateMutationVariables>;
export const ReviewPublishDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "mutation",
			name: { kind: "Name", value: "ReviewPublish" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
			...
			selectionSet: {
				...
				selections: [
					{
						kind: "Field",
						name: { kind: "Name", value: "publishReview" },
						arguments: [
							{
								kind: "Argument",
								name: { kind: "Name", value: "where" },
...
} as unknown as DocumentNode<ReviewPublishMutation, ReviewPublishMutationVariables>;
export const ReviewsGetByProductDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "ReviewsGetByProduct" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
...
} as unknown as DocumentNode<ReviewsGetByProductQuery, ReviewsGetByProductQueryVariables>;
